...
async function run() {
  ...
  // モバイル PWA 用
  writeFileSync(resolve(root, 'mobile/public/icons/icon-512.png'), png512);
  writeFileSync(resolve(root, 'mobile/public/icons/icon-192.png'),
    await sharp(svgBuf).resize(192, 192).png().toBuffer()
  );
  console.log('mobile icons done');
}
